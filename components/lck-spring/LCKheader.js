const LCKHeader = () => (
  <div className="LCSHeader">
    <h1>2020 LCK Spring Predictions</h1>
    <p className="timestamp">Updated: Monday, 20 April 2020</p>
    <p>
      LCK predictions are based of a slightly modified version of the{" "}
      ...
      many LCK teams have major roster changes between seasons.
    </p>
    <p>
      ...
      NFL predictions, slightly adapted for the LCK.
    </p>
