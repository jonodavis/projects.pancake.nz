...
import LCSHeader from "../components/lcs-summer/LCSheader"
...
export async function getStaticProps() {
  ...
  const resMatches = await fetch(
    "https://raw.githubusercontent.com/jonodavis/lcs-elo-backend/master/out/summer/LCSmatches.json"
  )
