...
import LECHeader from "../components/lec-summer/LECheader"
...
LECSummer.getInitialProps = async function () {
  const resTeams = await fetch(
    "https://raw.githubusercontent.com/jonodavis/lcs-elo-backend/master/out/summer/LECteams.json"
  )
  const teams = await resTeams.json()

  const resMatches = await fetch(
    "https://raw.githubusercontent.com/jonodavis/lcs-elo-backend/master/out/summer/LECmatches.json"
  )
